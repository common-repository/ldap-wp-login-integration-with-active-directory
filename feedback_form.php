...
?>
    ...
    <div class="card" id="feedbackfrm" style="margin-left:30%;position:fixed;z-index:999; top:0px; margin-top:8rem;max-width:36rem;display: none;">
        <div>
            <form action="" method="POST" id="feedbackform">
                ...
                <h3> Your Feedback </h3>
                <h4>Please take a moment for feedback, it will assist us to enhance <br> the plugin's consistency.</h4>
    ...
    <script>
        ...
        var deactivateButton = document.getElementById("deactivate-ldap-wp-login-integration-with-active-directory");

        jQuery('#deactivate-ldap-wp-login-integration-with-active-directory').on('click', function(e) {
